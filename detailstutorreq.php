...
<div class="container">
	...
	while($row = $result->fetch_assoc()) {?>
		...
		<div class="single-tutor">
			...
			<p><span>Requested Tutor Qualification:</span> <?php echo $row["t_qualification"] ?></p>
			<p><span>Requested Tutor Area:</span> <?php echo $row["area"] ?></p>
			<p><span>Require Tutor for  :</span> <?php echo $row["class"] ?></p>
			<p><span>Requested Tutor Honorary :</span> <?php echo $row["honorary"] ?></p>
